...
export default function ChatbotBox(props: { chatId: string }) {
  const [messages, setMessages] = useState<Message[]>([
    ...
    },
    {
      id: '3',
      type: 'bot',
      content: 'Of course! React Hooks are functions that let you use state and other React features in functional components. The most common hooks are useState for managing state and useEffect for side effects. Would you like me to explain any specific hook in detail?',
      timestamp: new Date(),
    },
  ]);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const botMessage: Message = {
        ...
        type: 'bot',
        content: 'This is a simulated response. In a real application, this would connect to your AI backend service.',
        timestamp: new Date(),
      };
